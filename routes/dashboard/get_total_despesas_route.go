...
func GetDashboardTotalDespesasRoute(c *gin.Context) {
	...
	response, err := dashboardController.GetDashboardTotalDespesasController(
		idUsuario,
		filters.idGrupoJWT,
		filters.dataInicio,
		filters.dataFim,
	...
	if err != nil {
		...
		c.JSON(http.StatusInternalServerError, gin.H{
			"error": "Erro ao buscar total de despesas do dashboard",
		})
		return
	}
