...
func GetDashboardTotalGanhosRoute(c *gin.Context) {
	...
	response, err := dashboardController.GetDashboardTotalGanhosController(
		idUsuario,
		filters.idGrupoJWT,
		filters.dataInicio,
		filters.dataFim,
	...
	if err != nil {
		...
		c.JSON(http.StatusInternalServerError, gin.H{
			"error": "Erro ao buscar total de ganhos do dashboard",
		})
		return
	}
