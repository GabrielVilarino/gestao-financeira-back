...
func UpdateTransacaoRoute(c *gin.Context) {
	var request schemas.UpdateTransacaoRequest
	...
	response, err := transacaoController.UpdateTransacaoController(idUsuario, idGrupoJWT, request)
	if err != nil {
		configs.Log.Error(err)
