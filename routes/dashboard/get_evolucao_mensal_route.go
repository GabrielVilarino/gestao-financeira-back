...
func GetDashboardEvolucaoMensalRoute(c *gin.Context) {
	...
	response, err := dashboardController.GetDashboardEvolucaoMensalController(
		idUsuario,
		filters.idGrupoJWT,
		filters.dataInicio,
		filters.dataFim,
	...
	if err != nil {
		...
		c.JSON(http.StatusInternalServerError, gin.H{
			"error": "Erro ao buscar evolução mensal do dashboard",
		})
		return
	}
